    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(view, "progress", 0, 99);
                objectAnimator.setDuration(2000).setInterpolator(new AccelerateDecelerateInterpolator());
